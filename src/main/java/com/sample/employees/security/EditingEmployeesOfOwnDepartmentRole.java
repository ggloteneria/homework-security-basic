...
//            actions = {RowLevelPolicyAction.CREATE, RowLevelPolicyAction.DELETE, RowLevelPolicyAction.UPDATE}
//    )
//    default RowLevelBiPredicate<Employee, ApplicationContext> task() {
